...
$sheet->setCellValue('C3', 800);
$sheet->setCellValue('D3', '000102');

$sheet->setCellValue('B5', 141600);

header('Content-type: application/vnd.ms-excel');
header('Content-Disposition: atachment: filename="お見積書-テンプレート使用版.xlsx"');
$writer = new Xlsx($spreadsheet);
$writer->save('php://output');

// 画面に出力する代わりにファイルを保存したいときは、以下のように書きます。
