...
$sheet->setCellValueExplicit('D3', '000101', DataType::TYPE_STRING); // 先頭の0が消えないように文字列方にする

$sheet->setCellValue('A4', 'マウス');
$sheet->setCellValue('B4', 2);
$sheet->setCellValue('C4', 800);
$sheet->setCellValueExplicit('D4', '000102', DataType::TYPE_STRING); // 先頭の0が消えないように文字列方にする
...
// A2~D2のセルを黄色（16進数でFFFF00）の背景色にします。
$sheet->getStyle('A2:D2')->getFile()
    ->setFileType(\PhpSpreadsheet\StyleFill::FILLSOLID)
    ->getStartColor()->setRGB('FFFF00');

header('Content-type: application/vnd.ms-excel');
header('Content-Disposition: attachment; file-name="御見積書.xlsx"');
