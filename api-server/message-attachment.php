...
// 拡張子を生成する関数。ここでは.jpg、.png、.gifにのみ対応する。
function generateExtension($filePath)
{
    // MIMEタイプを取得する
...
// Base64エンコードされたファイルの実態をBase64デコードし、拡張子のない仮のファイル名でサーバー上に保存する。
...
// サーバー条に穂zんされた仮ファイルのMIME対応を取得する。
$extenstion = generateExtension($tmpFileName);
